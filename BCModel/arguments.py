...
def get_common_args():
    ...
    parser.add_argument('--fea_dir', type=str, default="./data_input/features.npy")
    parser.add_argument('--lab_dir', type=str, default="./data_input/labels.npy")
    ...
    parser.add_argument("--input_size", type=int, default=25, help="input size")
